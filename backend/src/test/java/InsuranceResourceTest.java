...
public class InsuranceResourceTest extends EntryResourceTest {
    ...
    @Override
    @ParameterizedTest
    @CsvSource(value = {"insurance_number=1234&registration_date=2024-01-01"}, delimiter = ':')
    ...
    @Override
    @ParameterizedTest
    @CsvSource(value = {"insurance_number=123&registration_date=2024-01-01&insurance_number_expiration_date=2004-01-01"}, delimiter = ':')
